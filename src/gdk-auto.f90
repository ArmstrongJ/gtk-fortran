...
function gdk_win32_window_is_win32(window) bind(c) 
  use iso_c_binding, only: c_int, c_ptr
  integer(c_int) :: gdk_win32_window_is_win32
  type(c_ptr), value :: window
end function

!  gpointer gdk_win32_handle_table_lookup (GdkNativeWindow handle);
function gdk_win32_handle_table_lookup(handle) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_win32_handle_table_lookup
  type(c_ptr), value :: handle
end function

!  void gdk_win32_hdc_release (GdkDrawable *drawable, GdkGC *gc, GdkGCValuesMask usage);
subroutine gdk_win32_hdc_release(drawable, gc, usage) bind(c) 
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
...
!  void gdk_win32_selection_add_targets (GdkWindow *owner, GdkAtom selection, gint n_targets, GdkAtom *targets);
subroutine gdk_win32_selection_add_targets(owner, selection, n_targets, targets&
&) bind(c) 
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr), value :: owner
  type(c_ptr), value :: selection
...
!  GdkDrawable *gdk_win32_begin_direct_draw_libgtk_only (GdkDrawable *drawable, GdkGC *gc, gpointer *priv_data, gint *x_offset_out, gint *y_offset_out);
function gdk_win32_begin_direct_draw_libgtk_only(drawable, gc, priv_data, x_off&
&set_out, y_offset_out) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_win32_begin_direct_draw_libgtk_only
  type(c_ptr), value :: drawable
  type(c_ptr), value :: gc
  type(c_ptr), value :: priv_data
  type(c_ptr), value :: x_offset_out
  type(c_ptr), value :: y_offset_out
end function

! void gdk_win32_end_direct_draw_libgtk_only (gpointer priv_data);
subroutine gdk_win32_end_direct_draw_libgtk_only(priv_data) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: priv_data
end subroutine

!  GdkWindow * gdk_win32_window_foreign_new_for_display (GdkDisplay *display, GdkNativeWindow anid);
function gdk_win32_window_foreign_new_for_display(display, anid) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_win32_window_foreign_new_for_display
  type(c_ptr), value :: display
  type(c_ptr), value :: anid
end function

! GdkWindow * gdk_win32_window_lookup_for_display (GdkDisplay *display, GdkNativeWindow anid);
function gdk_win32_window_lookup_for_display(display, anid) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: gdk_win32_window_lookup_for_display
  type(c_ptr), value :: display
  type(c_ptr), value :: anid
end function
