! Automatically generated by cfwrapper.py on Tue Apr  9 16:46:13 2013
...
function pango_win32_get_context() bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_get_context
end function

!  PangoGlyph pango_win32_get_unknown_glyph (PangoFont *font, gunichar wc);
function pango_win32_get_unknown_glyph(font, wc) bind(c) 
  use iso_c_binding, only: c_int32_t, c_ptr
  integer(c_int32_t) :: pango_win32_get_unknown_glyph
  type(c_ptr), value :: font
  integer(c_int32_t), value :: wc
end function

!  gint pango_win32_font_get_glyph_index(PangoFont *font, gunichar wc);
function pango_win32_font_get_glyph_index(font, wc) bind(c) 
  use iso_c_binding, only: c_int, c_ptr, c_int32_t
  integer(c_int) :: pango_win32_font_get_glyph_index
  type(c_ptr), value :: font
  integer(c_int32_t), value :: wc
end function

!  gboolean pango_win32_get_debug_flag (void);
function pango_win32_get_debug_flag() bind(c) 
  use iso_c_binding, only: c_int
  integer(c_int) :: pango_win32_get_debug_flag
end function

! void pango_win32_font_done_font (PangoFont *font);
subroutine pango_win32_font_done_font(font) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: font
end subroutine

! double pango_win32_font_get_metrics_factor (PangoFont *font);
function pango_win32_font_get_metrics_factor(font) bind(c) 
  use iso_c_binding, only: c_double, c_ptr
  real(c_double) :: pango_win32_font_get_metrics_factor
  type(c_ptr), value :: font
end function

!  PangoWin32FontCache *pango_win32_font_cache_new (void);
function pango_win32_font_cache_new() bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_cache_new
end function

! void pango_win32_font_cache_free (PangoWin32FontCache *cache);
subroutine pango_win32_font_cache_free(cache) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: cache
end subroutine

!  PangoFontMap *pango_win32_font_map_for_display (void);
function pango_win32_font_map_for_display() bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_map_for_display
end function

! void pango_win32_shutdown_display (void);
subroutine pango_win32_shutdown_display() bind(c) 
  use iso_c_binding, only: 
end subroutine

! PangoWin32FontCache *pango_win32_font_map_get_font_cache (PangoFontMap *font_map);
function pango_win32_font_map_get_font_cache(font_map) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_map_get_font_cache
  type(c_ptr), value :: font_map
end function

!  LOGFONTA *pango_win32_font_logfont (PangoFont *font);
function pango_win32_font_logfont(font) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_logfont
  type(c_ptr), value :: font
end function

! LOGFONTW *pango_win32_font_logfontw (PangoFont *font);
function pango_win32_font_logfontw(font) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_logfontw
  type(c_ptr), value :: font
end function

!  PangoFontDescription *pango_win32_font_description_from_logfont (const LOGFONTA *lfp);
function pango_win32_font_description_from_logfont(lfp) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_description_from_logfont
  type(c_ptr), value :: lfp
end function

!  PangoFontDescription *pango_win32_font_description_from_logfontw (const LOGFONTW *lfp);
function pango_win32_font_description_from_logfontw(lfp) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: pango_win32_font_description_from_logfontw
  type(c_ptr), value :: lfp
end function
