...
function gdk_pixbuf_animation_new_from_file(filename, error) bind(c,name="gdk_pixbuf_animation_new_from_file_utf8") 
...
function gdk_pixbuf_new_from_file(filename, error) bind(c,name="gdk_pixbuf_new_from_file_utf8") 
  use iso_c_binding, only: c_ptr, c_char
