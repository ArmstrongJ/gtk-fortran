...
function cairo_win32_surface_create_with_dib(format, width, height) bind(c) 
  use iso_c_binding, only: c_ptr, c_int
  type(c_ptr) :: cairo_win32_surface_create_with_dib
...
function cairo_win32_surface_get_image(surface) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: cairo_win32_surface_get_image
  type(c_ptr), value :: surface
end function

!  cairo_font_face_t * cairo_win32_font_face_create_for_logfontw (LOGFONTW *logfont);
function cairo_win32_font_face_create_for_logfontw(logfont) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr) :: cairo_win32_font_face_create_for_logfontw
  type(c_ptr), value :: logfont
end function

!  void cairo_win32_scaled_font_done_font (cairo_scaled_font_t *scaled_font);
subroutine cairo_win32_scaled_font_done_font(scaled_font) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: scaled_font
end subroutine

!  double cairo_win32_scaled_font_get_metrics_factor (cairo_scaled_font_t *scaled_font);
function cairo_win32_scaled_font_get_metrics_factor(scaled_font) bind(c) 
  use iso_c_binding, only: c_double, c_ptr
  real(c_double) :: cairo_win32_scaled_font_get_metrics_factor
  type(c_ptr), value :: scaled_font
end function

!  void cairo_win32_scaled_font_get_logical_to_device (cairo_scaled_font_t *scaled_font, cairo_matrix_t *logical_to_device);
subroutine cairo_win32_scaled_font_get_logical_to_device(scaled_font, logical_t&
&o_device) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: scaled_font
  type(c_ptr), value :: logical_to_device
end subroutine

!  void cairo_win32_scaled_font_get_device_to_logical (cairo_scaled_font_t *scaled_font, cairo_matrix_t *device_to_logical);
subroutine cairo_win32_scaled_font_get_device_to_logical(scaled_font, device_to&
&_logical) bind(c) 
  use iso_c_binding, only: c_ptr
  type(c_ptr), value :: scaled_font
  type(c_ptr), value :: device_to_logical
end subroutine
